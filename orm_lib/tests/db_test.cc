...
DROGON_TEST(PostgreTest) {
  ...
  *clientPtr << "insert into users (user_id,user_name,password,org_name) "
  ...
  /// 1.2 insert,blocking
  *clientPtr << "insert into users (user_id,user_name,admin,password,org_name) "
  ...
  *clientPtr << "truncate table users restart identity" >>
  ...
  /// 3.6 clean up
  try {
    auto r = clientPtr->execSqlSync("truncate table users restart identity");
    SUCCESS();
  } catch (const DrogonDbException &e) {
    FAULT("postgresql - DbClient asynchronous interface(5) what():",
          e.base().what());
  ...
  try {
    ...
    FAULT("postgresql - DbClient future interface(0) what():", e.base().what());
  }
  /// 4.2 insert
  ...
  try {
    ...
    FAULT("postgresql - DbClient future interface(1) what():", e.base().what());
  }
  /// 4.3 query
  f = clientPtr->execSqlAsyncFuture(
      "select * from users where user_id=$1 and user_name=$2",
  ...
  try {
    ...
    FAULT("postgresql - DbClient future interface(2) what():", e.base().what());
  }
  /// 4.4 query for none
  f = clientPtr->execSqlAsyncFuture(
      "select * from users where user_id=$1 and user_name=$2",
  ...
  try {
    ...
    FAULT("postgresql - DbClient future interface(3) what():", e.base().what());
  }
  /// 4.5 bad sql
  f = clientPtr->execSqlAsyncFuture(
  ...
  try {
    ...
    FAULT("postgresql - DbClient future interface(5) what():", e.base().what());
  }
  ...
  try {
    ...
    FAULT("postgresql - Row throwing exceptions(0) what():", e.base().what());
  }
  ...
  try {
    ...
    FAULT("postgresql - Row throwing exceptions(3) what():", e.base().what());
  }
  ...
  {
    std::vector<std::string> cols{Users::Cols::_avatar_id, Users::Cols::_salt};
    mapper.updateBy(
        cols,
  ...
  try {
    const Result users =
        QueryBuilder<Users>{}.from("users").select("id").execSync(clientPtr);
    MANDATE(users.size() == 3);
  ...
  auto coro_test = [clientPtr, TEST_CTX]() -> drogon::Task<> {
    ...
    try {
      auto result =
          co_await clientPtr->execSqlCoro("select * from users where 1=$1;", 1);
      MANDATE(result.size() != 0);
    } catch (const DrogonDbException &e) {
    ...
    try {
      CoroMapper<Users> mapper(clientPtr);
      auto users =
          co_await mapper.orderBy(Users::Cols::_user_id).limit(2).findAll();
    ...
    try {
      ...
      c = co_await mapper.updateBy(std::make_tuple(Users::Cols::_avatar_id,
                                                   Users::Cols::_salt),
                                   Criteria(),
                                   "avatar",
                                   "salt");
    ...
    try {
      ...
      auto result =
          co_await trans->execSqlCoro("select * from users where 1=$1;", 1);
      MANDATE(result.size() != 0);
    } catch (const DrogonDbException &e) {
      FAULT(
...
DROGON_TEST(MySQLTest) {
  ...
  *clientPtr << "USE drogonTestMysql" >> [TEST_CTX](const Result &r) {
    ...
    FAULT("mysql - Prepare the test environment(0) what():", e.base().what());
  };
  // mysql is case sensitive
  *clientPtr << "DROP TABLE IF EXISTS users" >> [TEST_CTX](const Result &r) {
    SUCCESS();
  } >> [TEST_CTX](const DrogonDbException &e) {
    FAULT("mysql - Prepare the test environment(1) what():", e.base().what());
  };
  *clientPtr << "CREATE TABLE users "
                "("
  ...
  /// Test1:DbClient streaming-type interface
  /// 1.1 insert,non-blocking
  *clientPtr << "insert into users (user_id,user_name,password,org_name,admin) "
                "values(?,?,?,?,?)"
             << "pg"
             << "postgresql"
             << "123"
  ...
  *clientPtr << "truncate table users" >> [TEST_CTX](const Result &r) {
  ...
  auto coro_test = [clientPtr, TEST_CTX]() -> drogon::Task<> {
    ...
    try {
      ...
      FAULT("mysql - DbClient coroutine interface(0) what():", e.base().what());
    }
    /// 7.2 Parameter binding
    try {
      auto result =
          co_await clientPtr->execSqlCoro("select * from users where 1=?;", 1);
      MANDATE(result.size() != 0);
    } catch (const DrogonDbException &e) {
      FAULT("mysql - DbClient coroutine interface(1) what():", e.base().what());
    }
  };
  drogon::sync_wait(coro_test());
...
DROGON_TEST(SQLite3Test) {
  ...
  *clientPtr << "UPDATE sqlite_sequence SET seq = 0" >>
  ...
  try {
    ...
    FAULT("sqlite3 - DbClient future interface(0) what():", e.base().what());
  }
  /// 4.2 insert
  f = clientPtr->execSqlAsyncFuture(
      "insert into users  (user_id,user_name,password,org_name,create_time) "
  ...
  try {
    ...
    FAULT("sqlite3 - DbClient future interface(1) what():", e.base().what());
  }
  /// 4.3 query
  f = clientPtr->execSqlAsyncFuture(
      "select * from users where user_id=? and user_name=?",
  ...
  try {
    ...
    FAULT("sqlite3 - DbClient future interface(2) what():", e.base().what());
  }
  /// 4.4 query for none
  f = clientPtr->execSqlAsyncFuture(
      "select * from users where user_id=? and user_name=?",
  ...
  try {
    ...
    FAULT("sqlite3 - DbClient future interface(3) what():", e.base().what());
  }
  /// 4.5 bad sql
  f = clientPtr->execSqlAsyncFuture(
      "select * from users where user_id=? and user_name='12'",
  ...
  try {
    ...
    FAULT("sqlite3 - DbClient future interface(5.1) what():", e.base().what());
  }
  ...
  try {
    ...
    FAULT("sqlite3 - DbClient future interface(5.2) what():", e.base().what());
  }
