...
struct sqlite3_value
{
    union MemValue
    {
        ...
        // int nZero;          /* Extra zero bytes when MEM_Zero and MEM_Blob
        // set */
    } u;
...
struct FuncDef
{
    ...
    //   void (*xSFunc)(sqlite3_context*,int,sqlite3_value**); /* func or
    //   agg-step */ void (*xFinalize)(sqlite3_context*);                  /*
    //   Agg finalizer */ void (*xValue)(sqlite3_context*); /* Current agg value
    //   */ void (*xInverse)(sqlite3_context*,int,sqlite3_value**); /* inverse
    //   agg-step */ const char *zName;   /* SQL name of the function. */ union
    //   {
...
{
    sqlite3_value result;  // Mem *pOut;              /* The return value is
                           // stored here */
    FuncDef pFunc;         /* Pointer to function information */
    //   Mem *pMem;              /* Memory cell used to store aggregate context
    //   */ Vdbe *pVdbe;            /* The VM that owns this context */ int iOp;
