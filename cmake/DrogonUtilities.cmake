...
# ##############################################################################
# function drogon_create_models(model_path)
# ##############################################################################
function(drogon_create_models arg)
  if(ARGC LESS 1)
    message(STATUS "arguments error when calling drogon_create_model")
    return()
  endif()
  file(GLOB_RECURSE SCP_LIST ${ARGV1}/*.csp)
  foreach(cspFile ${SCP_LIST})
  ...
  endforeach()
  target_sources(${ARGV0} PRIVATE ${VIEWSRC})
endfunction(drogon_create_models)
