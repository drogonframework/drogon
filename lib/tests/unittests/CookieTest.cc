...
DROGON_TEST(CookieTest)
{
    ...
    CHECK(cookie5.cookieString() ==
		...
		CHECK(drogon::Cookie::SameSite::kLax == drogon::Cookie::convertString2SameSite("Lax"));
		CHECK(drogon::Cookie::SameSite::kStrict == drogon::Cookie::convertString2SameSite("Strict"));
		CHECK(drogon::Cookie::SameSite::kStrict == drogon::Cookie::convertString2SameSite("None"));
}
