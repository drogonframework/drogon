...
class DROGON_EXPORT HttpResponseImpl : public HttpResponse
{
  ...
  public:
    ...
    const std::unordered_map<std::string, Cookie, internal::SafeStringHash>
  ...
  private:
    ...
    std::unordered_map<std::string, std::string, internal::SafeStringHash>
        headers_;
    std::unordered_map<std::string, Cookie, internal::SafeStringHash> cookies_;
