...
// content type -> list of corresponding mime types, the first being the default (more standard) one + the mime type to return in contentTypeToMime() when not empty (mainly to return the charset for text types)
static const std::map<ContentType, std::pair<std::list<std::string_view>, std::string_view>> mimeTypeDatabase_{
    { CT_NONE,                       { { "" }, "" } },
    { CT_APPLICATION_OCTET_STREAM,   { { "application/octet-stream" }, "" } },
    { CT_APPLICATION_GZIP,           { { "application/gzip" }, "" } },
    { CT_APPLICATION_JSON,           { { "application/json" }, "application/json; charset=utf-8" } },
    { CT_APPLICATION_FONT_WOFF,      { { "application/font-woff" }, "" } },
    { CT_APPLICATION_FONT_WOFF2,     { { "application/font-woff2" }, "" } },
    { CT_APPLICATION_JAVA_ARCHIVE,   { { "application/java-archive", "application/x-java-archive" }, "" } },
    { CT_APPLICATION_MSWORD,         { { "application/msword" }, "" } },
    { CT_APPLICATION_MSWORDX,        { { "application/vnd.openxmlformats-officedocument.wordprocessingml.document" }, "" } },
    { CT_APPLICATION_PDF,            { { "application/pdf" }, "" } },
    { CT_APPLICATION_VND_MS_FONTOBJ, { { "application/vnd.ms-fontobject" }, "" } },
    ...
    { CT_APPLICATION_X_FONT_OPENTYPE,{ { "application/x-font-opentype", "font/otf" }, "" } },
    { CT_APPLICATION_X_FONT_TRUETYPE,{ { "application/x-font-truetype", "font/ttf" }, "" } },
    ...
    { CT_APPLICATION_XHTML,          { { "application/xhtml+xml", "application/xhtml" }, "application/xhtml+xml; charset=utf-8" } },
    { CT_APPLICATION_XML,            { { "application/xml" }, "application/xml; charset=utf-8" } },
    ...
    { CT_TEXT_JAVASCRIPT,            { { "text/javascript" }, "text/javascript; charset=utf-8" } },
...
static const std::map<std::string_view, std::pair<FileType, ContentType>> fileTypeDatabase_{
...
ContentType getContentType(const std::string &fileName)
{
    ...
    return (it == fileTypeDatabase_.end()) ? CT_CUSTOM
                                           : it->second.second;
}
...
std::list<std::string_view> getFileExtensions(ContentType contentType)
{
    ...
    std::call_once(flag, []() {
        ...
        extensionMap_[CT_TEXT_XML] =
            extensionMap_[CT_APPLICATION_XML];
    });
